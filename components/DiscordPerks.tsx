 ...
 *  none of that is Hipobuy's doing, so it gets its own card instead of living inside
 *  the trust bar (which is strictly Hipobuy's guarantees). */
    ...
    <div className="discord-standalone">
      <a className="discord-cta" href={LINKS.discord} target="_blank" rel="noopener" data-umami-event="discord_busca_foto">
        ...
        <span className="dc-tx">
          <b>¿Buscas otra prenda? Mándala en Discord</b>
          <span>Un bot te encuentra la mejor calidad por foto — además, descuentos exclusivos y ayuda directa mía</span>
        </span>
